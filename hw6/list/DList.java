...
public class DList extends List {
   ...
   **/
  public DList() {
    DListNode sentinel = newNode(null, null, null, null);
  ...
  public void insertFront(Object item) {
    DListNode formerFront = this.head.next;
    DListNode newFront = newNode(item, this, this.head, formerFront);
    this.head.next = newFront;
    formerFront.prev = newFront;
    this.size++;
  }
  ...
  public void insertBack(Object item) {
	  DListNode formerBack = this.head.prev;
	  DListNode newBack = newNode(item, this, formerBack, this.head);
	  this.head.prev = newBack;
	  formerBack.next = newBack;
	  this.size++;
  }

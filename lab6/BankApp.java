...
public class BankApp {
  ...
  public static void main(String[] args) throws BadAccountException{
    ...
    String command;
    // Try/catch here
    // Bug when trying to withdraw negative
    // Spits two messages because ATM.deposit method itself gives a message, but the dodeposit method sends out another
    // regardless of whether the atm acc exists
	try {
		command = bankApp.readLine("--> ");
		while (!command.equals("quit")) {
		      try {
		    	  
		    	  // Catch badaccountexception

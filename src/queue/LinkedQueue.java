...
public class LinkedQueue implements Queue {
  ...
  /**
   *  find() checks if the object exists in the Queue.
   *  @return true if the object you want to find is in the Queue.
   *  @throws a QueueEmptyException if the Queue is empty.
   **/
  
  public boolean find(Object item) throws QueueEmptyException {
    if (head == null) {
      throw new QueueEmptyException();
    } else {
